...
contract ShepherdCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Shepherd Coin";
    ...
    address payable public marketingWallet = payable(0xBd0Fd7C0aAD19E6FD5b23874924dF197cc46Eb06);
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // mainnet router address
